// Vendored from async_value 0.2.7 (WTFPL-2.0).
...
pub enum AError {
    #[error("Async ERROR: AsyncNotStarted")]
    AsyncNotStarted,
    #[error("Async ERROR: AsyncNotReady")]
    AsyncNotReady,
    #[error("Async ERROR: AsyncRunning")]
    AsyncRunning,
    #[error("Async ERROR: AsyncFailed")]
    AsyncFailed,
    #[error("Async ERROR: AsyncStale")]
    AsyncStale,
    #[error("Async ERROR: AsyncValuePulled")]
    AsyncValuePulled,
    #[error("Async ERROR: AsyncValueMoved")]
    AsyncValueMoved,
    #[error("Async ERROR: AsyncValueEmpty")]
    AsyncValueEmpty,
    #[error("Async ERROR: NoValueFn")]
    NoValueFn,
    #[error("Async ERROR: NoReadyFn")]
    NoReadyFn,
    #[error("Async ERROR: MutexPoisoned")]
    MutexPoisoned,
    #[error("Async ERROR: NoThreadPool")]
    NoThreadPool,
    #[error("Async ERROR: OtherError({0:?})")]
